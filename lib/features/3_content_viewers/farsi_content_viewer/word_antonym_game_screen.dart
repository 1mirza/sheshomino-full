...
class WordAntonymGameScreen extends StatefulWidget {
  final int lessonNumber;
  final String userName;

  const WordAntonymGameScreen({
    super.key,
  ...
  @override
  State<WordAntonymGameScreen> createState() => _WordAntonymGameScreenState();
}

class _WordAntonymGameScreenState extends State<WordAntonymGameScreen> {
  Timer? _timer;
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('بازی کلمات متضاد'),
          leading: IconButton(
  ...
  Widget _buildQuestionCard() {
    return Card(
      child: Padding(
        ...
        child: Text(
          'متضاد کلمه‌ی "${_quizWords[_currentQuestionIndex].word}" چیست؟',
